...
class Settings(BaseSettings):
	...
	ALLOWED_ORIGINS: str = Field(default="http://localhost:5173") # Change this to the actual frontend URL in production, can be a comma-separated list of origins if needed
