...
async def ws_team_frames(websocket: WebSocket, team_id: int) -> None:
    """Subscribe to live energy frame updates for all ECUs belonging to a team.

    The server pushes a JSON object for every new frame recorded for any ECU
    in the team. Clients should not send anything; the connection is receive-only.
    """
